use crate::core_impl::config::NearBindgenConfig;
...
fn filter_ext_function_non_bindgen_attrs(
    ...
    let blacklisted_attrs = config.blacklist_ext_fn_attrs.clone().unwrap_or_default();
