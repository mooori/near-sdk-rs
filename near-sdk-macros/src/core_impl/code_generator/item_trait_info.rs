...
use crate::core_impl::NearBindgenConfig;
use proc_macro2::TokenStream as TokenStream2;
use quote::quote;

impl ItemTraitInfo {
    /// Generate code that wrapps external calls.
    pub fn wrap_trait_ext(&self, config: &NearBindgenConfig) -> TokenStream2 {
...
mod tests {
    ...
    fn ext_basic() {
        ...
        let actual = info.wrap_trait_ext(&NearBindgenConfig::default());
